...
class FibaroSwipeDevice extends ZwaveDevice {
  ...
  onNodeInit() {
    ...
    // Needed because of the removal of the battery_alarm capability
    ...
    this.registerReportListener('CENTRAL_SCENE', 'CENTRAL_SCENE_NOTIFICATION', report => {
      ...
      if (report['Scene Number'] >= 1
        ...
        this.homey.flow.getDeviceTriggerCard('fggc-001_swipe_direction')
          .trigger(this, null, swiped)
          .catch(this.error);
      } else if (report['Scene Number'] >= 5
        && report['Scene Number'] <= 6) {
